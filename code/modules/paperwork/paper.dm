...
/obj/item/paper/lv624brief
	name = "paper= 'CLASSIFIED - LV624 Briefing Minutes'"
	info = "<style>body{margin:0 auto;padding:0;background-image:url('https://i.imgur.com/uM2I2gT.jpg');font-family:monospace}#fax-logo{text-align:center}#fax-logo img{width:250px;margin-top:20px;margin-bottom:12px;opacity:.6}</style><p>071203(Z)APR5</p><p style="text-align:center"><span style="text-decoration:underline"><span style="color:#f00"><strong>CLASSIFIED</strong></span></span></p><p style="text-align:center"><strong>Department of Marine Colonial Assistance</strong></p><p><strong>From:</strong> Sector 218 Central Command.</p><p><strong>Time Zone Used throughout</strong>: Zulu</p><p><strong>SITUATION:</strong></p><p>A distress signal has been received from the colonial marshals office in Nanotransen Ground Research Base LV-624. According to the original reporter, Xenomorphic entities have been reported in the area. Number: Unknown. Known to be extremely hostile. Xenomorphs possess claws sharp enough to penetrate armor and corrosive blood. Certain xenomorphs possess the ability to fire corrosive and/or neurotoxic projectiles. Extreme caution is advised. Zoological information may be found under Enemy Forces.</p><p><strong>ENEMY FORCES:</strong><p>The following is a collection of information on the possible xenomorphic entities that may be encountered at the nanotransen research facility, this is not a complete listing due to the nature of these creatures and must be supplemented by field intel:</p><p style="padding-left:30px">Larvae - limbless entity, identifiable by small size, primary method of attack is bites, poses minimal risk, termination advised if spotted but higher value targets should be prioritized. target priority: 3/5</p><p style="padding-left:30px">Drone - Bipedal entity, identifiable by head crest, primary method of attack is claws, able to vomit high strength nitric/sulfuric acid blend on obstacles, generally seen acting as a construction worker for hives. target priority: 3/5</p><p style="padding-left:30px">Runner - Quadrupedal entity, identifiable by red colouration, primary method of attack is claws, appears to prefer attacking lone targets, main risk is posed by the friendly fire the entity causes. target priority: 2/5</p><p style="padding-left:30px">Sentinel - Bipedal entity, identifiable by unique head trimmings, primary method of attack is claws, supplemented with concentrated carfentanil spit, generally seen defending hives. target priority: 3/5</p><p style="padding-left:30px">Defender - Dual Bipedal/Quadrupedal entity, identifiable by thick head crest and back spikes, primary method of attack is tail, supplemented claws and skull-ramming, generally seen protecting paths of retreat for other xenomorphic entities. target priority: 3/5.</p><p style="padding-left:30px">Queen - Bipedal entity, identifiable by disproportionate size and crest. primary method of attacks consist of carfentanil spit, claws, 160-165 dB sound blast and air-borne nitric/sulfuric acid spit. Reports say that this entity acts as the de-facto leader of xenomorph hives, along with producing facial parasite 485-24, the main cause of infestations. Eliminating this target is of the highest priority and all methods are authorized. target priority: 5/5 </p><p><strong>FRIENDLY FORCES:</strong></p><p>1x DMCA Rifle Platoon</p><p>1x AMEDD Medical Treatment and Research Squad</p><p>1x USACE Maintenance detachment.</p><p>1x DMCADOL Logistical Support group</p><p>1x NT D-Model Synthetic *</p><small>* Depending on the current budget allocated to the ship, you may or may not be supplied with a synthetic unit.</small><p><strong>Aerospace Wing:</strong></p><p>1x Almayer-Class Troop Transport Ship, On unconditional loan from NT.</p><p>1x AXE-32 Dropship, Codenamed Normandy, Designed for CAS operations.</p><p>1x AXE-32 Dropship, Codenamed Alamo, Designed for Troop Transport and CASvac operations.</p><p><strong>MISSION:</strong></p><p style="padding-left:30px"><strong>1. Purpose:</strong></p><p style="padding-left:30px">Resolve the infection on the colony and ensure the safety of all survivors.</p><p style="padding-left:30px"><strong>2. Key Tasks:</strong></p><p style="padding-left:30px">Rifle Platoon will conduct investigation and elimination of any xenomorphic lifeform at the ground research base.</p><p style="padding-left:30px">The entire colony must be swept through and secured.</p><p style="padding-left:30px">All survivors of the incident must be rescued.</p><p style="padding-left:30px"><strong>3. Endstate:</strong></p><p style="padding-left:30px">The incident is resolved with minimal losses and control of colony returned to Nanotransen.</p><p><strong>Scheme of Maneuver:</strong></p><p>The infantry platoon, split into 4 squads, are to be deployed on the dropships via orbital insertion, touching down on the two marked LZs. The platoon will then enter the colony and secure all structures. Marines are to terminate all wildlife sighted. Details will be decided at commander's initiative.</p><p><strong>Fire Support Plan:</strong></p><p>USS Almayer will insert at geosynchronous orbit and at optimal fire spread angle to provide orbital artillery support.</p><p><strong>Administration/Logistics:</strong></p><p style="padding-left:30px"><strong>1. Administration</strong></p><p style="padding-left:30px">MEDEVAC plan: Medics are to bring all patients to the nearest dropship. If patients show signs of parasitic infection or report a violation of their face they are to be brought to the nearest fully equipped surgical ward as quickly as possible. Any patients in critical condition are to be evacuated through the Fulton stretcher system.</p><p style="padding-left:30px"><strong>2. Logistics</strong></p><p style="padding-left:30px">The standard combat load will be carried by personnel. Supplies will be delivered to marines via orbital drop.</p><br><br><p style="padding-left:30px"><strong>Sponsored by Nanotransen. Nanotransen, we don't just create the future, we bring it to you.</strong></p><div id='fax-logo'><img src='https://tgstation13.org/wiki//images/thumb/e/ee/NTlogo.png/400px-NTlogo.png'/></div>"
